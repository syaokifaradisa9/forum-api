...
DomainErrorTranslator._directories = {
  ...
  'NEW_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('harus mengirimkan content, threadId dan owner'),
  'NEW_COMMENT.NOT_MEET_DATA_TYPE_SPESIFICATION': new InvariantError('tidak dapat membuat thread baru karena tipe data tidak sesuai'),
};
